    ...
    <div className="bg-white shadow-lg rounded-lg p-8 pb-12 mb-8">
      ...
      <form>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4">
          ...
          <input type="email" value={formData.email} onChange={onInputChange} className="py-2 px-4 outline-none w-full rounded-lg focus:ring-2 focus:ring-gray-200 bg-gray-100 text-gray-700" placeholder="Email" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" />
        </div>
        <div className="grid grid-cols-1 gap-4 mb-4">
          <div>
